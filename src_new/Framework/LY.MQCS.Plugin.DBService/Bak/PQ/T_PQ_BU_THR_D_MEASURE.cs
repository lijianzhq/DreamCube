...
namespace LY.MQCS.Plugin.DBService.Bak.PQ
{
    ...
    ///3D测量数据表
    /// </summary>
    public partial class T_PQ_BU_THR_D_MEASURE
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public T_PQ_BU_THR_D_MEASURE()
        {
            this.T_PQ_BU_THR_D_MEASURE_D = new HashSet<T_PQ_BU_THR_D_MEASURE_D>();
        }
    ...
    public string DATA_SOURCE { get; set; }
        ...
        public virtual ICollection<T_PQ_BU_THR_D_MEASURE_D> T_PQ_BU_THR_D_MEASURE_D { get; set; }
    }
}
