...
namespace Mini.Foundation.Basic.Utility
{
    public static class MyString
    {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static Int32 GetByteLength(String sStr)
        {
#if !(NETSTANDARD1_0 || NETSTANDARD1_3)
            if (string.IsNullOrEmpty(sStr) == false)
                return Encoding.Default.GetByteCount(sStr);
            else
                return 0;
#else 
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static String GetSubStringB(String str, Int32 len)
        {
            String result = String.Empty;
            // 最终返回的结果 
            Int32 byteLen = MyString.GetByteLength(str);
            // 单字节字符长度 
            Int32 charLen = str.Length;
            // 把字符平等对待时的字符串长度 
            Int32 byteCount = 0;
            // 记录读取进度 
            Int32 pos = 0;
        ...
        /// <returns></returns>
        public static String CutAndCheckStr(String txt, Int32 length)
        {
        ...
        /// <param name="length">要截取的长度</param>
        /// <returns></returns>
        public static String Cut(String txt, Int32 length)
        {
#if !NETSTANDARD1_0
            ...
            if (txt.Length > length)
            {
                ...
                for (Int32 i = 0; i < txt.Length; i++)
                {
                    ...
                    if (tempnum2 * 2 + tempnum1 >= length * 2) break;
                }
        ...
        /// <returns></returns>
        public static String Cut(String txt, Int32 length, String endstr)
        {
#if !NETSTANDARD1_0
            //取得自定义长度的字符串  中文123456789
            String outputtext = "";
        ...
        {
            MyArgumentsHelper.ThrowsIfNull(ms, nameof(ms));
        ...
        {
            MyArgumentsHelper.ThrowsIfNull(byteArray, nameof(byteArray));
        ...
        {
            MyArgumentsHelper.ThrowsIfNull(hexString, nameof(hexString));
